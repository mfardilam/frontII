...
//-----------------------------------------------------------Clase 6 - 18 Mayo
//Practicando con atributos
// const imagenes = document.querySelectorAll(".noticias article img");
// console.log(imagenes);
// console.log("alrt: "+imagenes[0].getAttribute("alt"));
...
//Comentamos los articles y los vamos a agregar con js
/*Se puede agregar elementos de 2 maneras, con templates literals o agregandolo con js, como a continuación */
